...
const game_datas = {
  state: "1",
  day: "1",
  player_infos: `You are in the village, you have to explore the world to become stronger and deliver the village from the claws of terrible Zrog the Dragon.
  <br />
